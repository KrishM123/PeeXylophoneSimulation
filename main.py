...
# Smaller TIME_STEP results in higher accuracy results
TIME_STEP = 0.00001  # s
...
# The following 7 lines basically rename variables to match the variable names from the related derivations
R = H_POS
g = 9.81
h = INIT_HEIGHT
V3 = V_VEL
print(f"Impact velocity is: {V_VEL}. Range is: {H_POS}")
